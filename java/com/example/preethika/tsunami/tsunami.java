package com.example.preethika.tsunami;
...
public class tsunami extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tempAsyncTask tm=new tempAsyncTask();
        tm.execute(USGS_REQUEST_URL);
    }
    ...
    private class tempAsyncTask extends AsyncTask <String,Void,Event>
    {
        @Override
